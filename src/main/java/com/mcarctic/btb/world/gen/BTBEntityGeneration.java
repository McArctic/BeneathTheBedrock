...
import com.mcarctic.btb.registry.BTBBiomes;
...
public class BTBEntityGeneration {
    public static void onEntitySpawn(final BiomeLoadingEvent event) {
        addEntityToSpecificBiomes(event, BTBEntityTypes.VOID_CRAWLER.get(),
                80, 4, 8, BTBBiomes.VOID_PLAINS);
    }

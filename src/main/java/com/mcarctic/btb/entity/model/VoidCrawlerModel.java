...
@OnlyIn(Dist.CLIENT)
public class VoidCrawlerModel<T extends Entity> extends HierarchicalModel<T> {
    ...
    public VoidCrawlerModel(ModelPart pRoot) {
        this.root = pRoot;
    ...
    public static LayerDefinition createVoidCrawlerBodyLayer() {
